...
export function isBrowserPostHogEnabled(): boolean {
  return Boolean(import.meta.env.VITE_POSTHOG_HOST && import.meta.env.VITE_POSTHOG_PROJECT_TOKEN);
}

export function getPostHogRecordingConsoleLogEnabled(): boolean {
  return (import.meta.env.VITE_POSTHOG_ENABLE_RECORDING_CONSOLE_LOG ?? "false") === "true";
}
